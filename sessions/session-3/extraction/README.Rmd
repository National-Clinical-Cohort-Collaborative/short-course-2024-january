...
* The group decides to step back and address the associations of being pecked or buttened
...
1. Notice `pt_observation` has fewer rows than `patient_ll`.  
   * Q1: Why?  
   * Q2: Can we use `pt_observation` directly in the analysis?  Why not?
   * Q3: What rows are missing from `pt_observation`, and how can we fill in those rows?
