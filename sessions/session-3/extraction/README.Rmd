...
1. Notice `patient` and `patient_ll` have the same record count.
   * Q1: Why?
   * Q2: If `patient` had *more* records than `patient_ll`, what went wrong?
   * Q3: If `patient` had *fewer* records than `patient_ll`, what went wrong?
