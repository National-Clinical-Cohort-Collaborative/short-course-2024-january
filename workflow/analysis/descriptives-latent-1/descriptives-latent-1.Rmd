...
read_chunk("./analysis/descriptives-latent-1/descriptives-latent-1.R") # This allows knitr to call chunks tagged in the underlying *.R file.
```
...
```{r latent-risk-1, echo=echo_chunks, message=message_chunks, fig.width=7}
```

COVID Severity
---------------------------------------------------------------------------

```{r covid-severity, echo=echo_chunks, message=message_chunks, fig.width=7}
```
...
```{r model-latent-risk-1, echo=echo_chunks, message=message_chunks}
```

### latent risk 1 -final

```{r model-latent-risk-1-final, echo=echo_chunks, message=message_chunks, warning=TRUE}
```
